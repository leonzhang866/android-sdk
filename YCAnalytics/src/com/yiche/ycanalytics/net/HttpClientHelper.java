...
import com.yiche.ycanalytics.utils.LogExceptionThreadFactory;
/**
 * HttpClientHelper
 */
...
//        }
//    };
    private static ThreadFactory threadFactory = new LogExceptionThreadFactory();
    static {
        threadPoolExecutor = new ThreadPoolExecutor(CORE_POOL_SIZE, MAX_POOL_SIZE, KEEP_ALIVE_TIME,
                TimeUnit.SECONDS, sPoolWorkQueue, threadFactory, new ThreadPoolExecutor.CallerRunsPolicy());
    }
