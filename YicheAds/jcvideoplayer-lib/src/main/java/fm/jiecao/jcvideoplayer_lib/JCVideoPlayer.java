...
//        surfaceView.setBackgroundColor(R.color.black_a10_color);
     ...
     * @param title 标题 | title
     */
    public void setUp(String url, String thumb, String title,AdClick adClick) {
        setUp(url, thumb, title, true);
     ...
     * @param title 标题 | title
     */
    public void setUp(String url, String thumb, String title,int picId) {
        setUp(url, thumb, title, true,picId);
    }

    public void setUp(String url, String thumb, String title, boolean ifShowTitle,int id) {
        setSkin();
